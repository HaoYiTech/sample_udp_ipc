...
BEGIN_MESSAGE_MAP(Csample_udp_ipcApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

Csample_udp_ipcApp::Csample_udp_ipcApp()
{
	m_dwRestartManagerSupportFlags = AFX_RESTART_MANAGER_SUPPORT_RESTART;
}

Csample_udp_ipcApp theApp;

BOOL Csample_udp_ipcApp::InitInstance()
{
